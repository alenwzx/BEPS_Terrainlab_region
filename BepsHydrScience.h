...
struct xvalue
{
    ...
    double x29;     //pond
    double x30;     //texture
    double x33;    //buff_soil_temp ��������
    double x36;     //nitrogen
    double x37;     //Ks
    double x38;      //prev_snowdepth ��������
...
#define MAX_LAYERS 5
typedef struct {
    // === ���漶״̬���� (Profile-level State Variables) ===
    float water_table;                  // ����ˮλ��� (m)
    float pondwater;                    // �ر���ˮ��� (m)
    float soil_temp;                    // **�������ƣ�����Ϊ������**: ����ƽ���¶� (c)
    float unsaturated_storage;          // **�������ƣ�����Ϊ������**: �Ǳ��ʹ���ˮ�� (��Чˮ�� m)
    float saturation_deficit;          // **�������ƣ�����Ϊ������**: �Ǳ��ʹ��ܱ��ͺ�ˮ���� (��Чˮ�� m)
    int   texture_index;                // �����ʵ�����
    // ̼�����C/N�� - ��ʱ��Ϊ����״̬����
    //*****************
...
//	char			szInFileNameSoilSurfK0[MAX_PATH];
    ...
    char			szInFileNameSoilInitMoisture[MAX_PATH];  // ���ӳ�ʼ����ˮ���ļ�·��
...
typedef struct
{
    ...
    char			szOutFileNameClimateTmean[MAX_PATH];	 //mean temperature ��������
...
struct CalibrationParam {
    std::string name;
    int texture_idx;
    int layer_idx;      // -1��ʾ���ò�����>=0��ʾ�ֲ����
    double current_value;
    double min_value;
    double max_value;
    double step;
    bool is_layered;    // �Ƿ�Ϊ�ֲ����
};
